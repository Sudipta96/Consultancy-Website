    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('which_year_student', models.CharField(blank=True, choices=[('first_year', '1st Year'), ('second_year', '2nd Year'), ('third_year', '3rd Year'), ('fourth_year', '4th Year'), ('just_passed', 'Just Passed')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate_id', models.CharField(blank=True, max_length=10, unique=True)),
