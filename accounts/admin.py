...
class CustomAccountAdmin(UserAdmin):
     ...
     list_display = ('email','username','is_active','is_staff','last_login',"date_joined", "list_image_preview")
 
     list_filter = ('email','username','is_active','is_staff')
     ordering = ('username',)
     readonly_fields = ["image_preview"]
     fieldsets = (
          ('User Info', {'fields':('fullname', 'username',"email", "gender", 'contact_number', 'avatar', "image_preview")}),
